...
<body>
    <div id="main" class="center">
        ...
        <c:when test="${empty sqlError}">
        	...
        	<h2>Total revenue for airline <nobr>&ldquo;<c:out value="${airlineName}" />&rdquo;</nobr>
        	on date <nobr>&ldquo;<c:out value="${departureDate}" />&rdquo;</nobr></h2>
        	<p>Revenue: <c:out value="${revenue}" /></p> 
        	</div>
        </c:when>
        <c:otherwise>
