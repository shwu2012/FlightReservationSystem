...
<body>
    <div id="main" class="center">
        ...
        <h2>Airline Names with employees of an average age over age
         <nobr>&ldquo;<c:out value="${age}" />&rdquo;</nobr></h2>
        <table class="result">
          <tr>
            <th>Airline Name</th>
          </tr>
          <c:forEach items="${fourthStatistics}" var="item">
          <tr>
            <td><c:out value="${item.airlineName}" /></td>
          </tr>
          </c:forEach>
        </table>
        </div>
