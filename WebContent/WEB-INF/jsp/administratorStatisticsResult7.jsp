...
<body>
    <div id="main" class="center">
        ...
        <h2>Airport names with the maximum number of departed flights</h2>
        <table class="result">
          <tr>
            <th>Airport Name</th>
            <th>Max Number</th>
          </tr>
          <c:forEach items="${seventhStatistics}" var="item">
          <tr>
            <td><c:out value="${item.airportName}" /></td>
            <td><c:out value="${item.maxNumOfDeparturedFlights}" /></td>
          </tr>
          </c:forEach>
        </table>
        </div>
